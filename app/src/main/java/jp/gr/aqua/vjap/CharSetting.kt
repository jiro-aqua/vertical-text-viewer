...
internal class CharSetting {
    ...
    private constructor(charcter: String, angle: Float, x: Float, y: Float) : super() {
    ...
    private constructor(charcter: String, angle: Float, x: Float, y: Float, scaleX: Float, scaleY: Float) : super() {
        this.charcter = charcter
        this.angle = angle
        this.x = x
        this.y = y
    ...
    companion object {
        ...
        private val sMap = HashMap<String, CharSetting>()

        fun getSetting(character: String): CharSetting? {
